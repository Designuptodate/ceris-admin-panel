    ...
    function bk_welcome_template() {
        ...
        foreach ($requiredPlugins as $theme_plugin) {
            if (is_plugin_active( $theme_plugin['file_path'])) {
                ...
                update_option('required_plugins', 1);
            }else {
                $allRequiredPluginsActivate = 0;
                update_option('required_plugins', 0);
                break;
            }
        }
    ?>
    ...
    <div class="page-wrap" style="margin: 20px 30px 0 2px;">
        ...
        <div class="postbox bkpostbox">
        	<div class="hndle" style="padding: 15px 30px;">
                <h1><?php esc_html_e('Welcome to Ceris', 'bkninja'); ?></h1>
                <p class="bk-admin-notice">
        			Thank you for using our theme, Ceris is now installed and ready to use!
        		</p>
                <?php if (! $allRequiredPluginsActivate ) {?>
                <p class="bk-admin-notice">
        			Note: You should install all required plugins and activate them to have Full Options of Ceris.
        		</p>
                <?php }?>
            </div>
        		...
        		<div class="main bk-welcome-main">
                    <div class="introduce clearfix">
                        ...
                        <div class="bk-welcome-content">
                            <p>Ceris supports one click demo importer, quickly get your site to look like our demo page and get started easily. You should make sure you have installed all required plugins and activate them to have Full Options of Ceris.</p>
                        </div>
                    </div>
                    <div class="bk-welcome-footer clearfix">
                        <div class="bk-welcome-footer-inner">
                            ...
                            <p>
                                Technical Support is free for all customers purchasing Ceris. For any questions or any bugs related to the setup of Ceris that are not covered by the theme documentation, please contact us via bkninja.team@gmail.com. Our support team is always ready to help you.
                                Our online documentation is an incredible resource for learning the ins and outs of using Ceris. Here you will find key points to manuals, tutorials and references that will come in handy easily.
                            </p>
                            <div class="bk-button"><a target="_blank" href="https://themeproducers.com/documentation/ceris_e/">Open Documentation</a></div>
                        </div>
                    </div>
        		</div>
        	</div>
