                    ...
                    $.post(ajaxurl, ajaxArgs, function (response) {
                        ...
                        if($results == 'plugin-active') {
                            ...
                            if(checkAllRequiredPlugins_isActive() == 0) {
                                req.parents('.page-wrap').find('.nav-tab:nth-child(2)').nextAll().remove();
                                $('#toplevel_page_bk-theme-welcome').find('li:nth-child(n+4)').remove();
                            }
                        }else {
        ...
        ajaxDemoImport: function() {
            ...
            function import_process(data, start_from) {
                ...
                if(start_from < data.attachments.length) {
                    ...
                    attachments[0]['data']['guid'] = 'https://allthebestsofts.com/ceris_demo/wp-content/uploads/2020/06/featured-image-1.jpg';
                    attachments[0]['remote_url'] = 'https://allthebestsofts.com/ceris_demo/wp-content/uploads/2020/06/featured-image-1.jpg';
